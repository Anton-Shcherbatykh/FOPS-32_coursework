...
Разворачиваю на одноимённой ВМ Kibana
...
- name: "download and install kibana"
  ...
  - name: "2/5 download kibana"
    get_url:
      url: https://mirror.yandex.ru/mirrors/elastic/8/pool/main/k/kibana/kibana-8.13.3-amd64.deb
      dest: "/home/shcherbatykh"

  - name: "3/5 dpkg -i kibana"
    apt:
      deb: /home/shcherbatykh/kibana-8.13.3-amd64.deb

  - name: "4/5 kibana configuration 'kibana.yml'"
    copy:
      src: /home/shcherbatykh/kibana.yml
